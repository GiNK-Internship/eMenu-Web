...
class HomeController extends Controller
{
    public function index($id)
    {
        ...
        $responseCategory = Http::get('http://192.168.1.109:8000/api/categories');
    ...
    {
        $tableIdInSession = Session::get('table_id');
        $responseTable = Http::get('http://192.168.1.109:8000/api/tables/' . $tableIdInSession . '/reservations');
        $dataTable = $responseTable->json();
        ...
        $response = Http::post('http://192.168.1.109:8000/api/order/store', $orderData);
